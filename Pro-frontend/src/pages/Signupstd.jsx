...
const Signupstd = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-yellow-200 via-red-400 to-blue-400">
      <form
      ...
      >
        ...
        <h3 className="text-white text-center mt-2 text-sm">
                    ...
                    <Link to="/login/student" className="text-yellow-300 font-semibold hover:underline">Login</Link>
                  </h3>
        <a
          href="/"
